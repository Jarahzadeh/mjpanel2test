...
[![Version](https://img.shields.io/badge/Version-v1.11.4-blue.svg?style=for-the-badge&logo=cloudflare)](https://github.com/mj-panel/MJ-PANEL)
...
[![License](https://img.shields.io/badge/License-Proprietary%20(Non--Commercial)-red.svg?style=for-the-badge)](https://github.com/mj-panel/MJ-PANEL/blob/main/LICENSE)
[![Project](https://img.shields.io/badge/Project-MJ_PANEL-2CA5E0.svg?style=for-the-badge&logo=cloudflare)](#)
</div>

<img  src="https://raw.githubusercontent.com/panel-mj/M-J/refs/heads/main/photos/dark.png"  width="100%"  alt="Mj Panel Dark Mode"  style="border-radius: 12px; margin-bottom: 15px;">

  
<img  src="https://raw.githubusercontent.com/panel-mj/M-J/refs/heads/main/photos/add.png"  width="100%"  alt="Mj Panel Dark Mode"  style="border-radius: 12px; margin-bottom: 15px;">
...
<img  src="https://raw.githubusercontent.com/panel-mj/M-J/refs/heads/main/photos/bot.png"  width="100%"  alt="Mj Panel Status"  style="border-radius: 12px;">

</td>

<td width="50%" valign="middle" align="center">

<img  src="https://raw.githubusercontent.com/panel-mj/M-J/refs/heads/main/photos/status.png"  width="100%"  alt="Mj Panel Dark Mode"  style="border-radius: 12px;">
...
[⚡️ Key Features](#️-features) • [🚀 Deployment Guide](#-quick-deployment-guide) • [🔎 IP Scanner](#-clean-ip-scanner) • [🛡️ SOCKS5 Proxy](#️-build-your-own-socks5-proxy-mj-relay) • [❤️ Thanks](#thanks) • [⚖️ License & Copyright](#license-copyright) • [Credits](#credits-section)
...
🚀 One-Click Deployment: Complete provisioning of the panel, subdomain, and D1 database directly via the Setup Guide.

🤖 Multi-Account Bot Management: Simultaneously manage multiple Cloudflare accounts, execute panel updates, and recover passwords using the Setup Guide.
...
<img src="https://img.shields.io/badge/MJ-Start-0088cc?style=for-the-badge&logo=cloudflare&logoColor=white" alt="Mj Setup Guide" height="40">
</a>
...
2. 👤 Prepare your Cloudflare token and account bindings.
3. 🔗 Create the required Cloudflare token in your dashboard.
4. 🟦 Scroll to the bottom of the Cloudflare page, click the blue `Continue to summary` button, and then click `Create Token`.
5. 🔑 Copy the generated token and keep it ready for deployment.
6. ⚡️ Once the token is ready, continue with your Cloudflare Worker deployment.
...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/panel-mj/M-J/main/mj-relay.sh | sed 's/\r$//')
```
...
MJ Panel features a highly optimized, multi-threaded local IP scanner. You can quickly find the fastest and most stable clean Cloudflare IPs directly from your device using the methods below:
...
```bash
python -c "import urllib.request; req = urllib.request.Request('https://raw.githubusercontent.com/panel-mj/M-J/refs/heads/main/mj-scanner.txt', headers={'User-Agent': 'Mozilla/5.0'}); exec(urllib.request.urlopen(req).read().decode('utf-8').split('---PYTH' + 'ON---')[1].split('---POWERSHELL---')[0].strip())"
...
```cmd
powershell -ExecutionPolicy Bypass -Command "[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12 -bor [Net.SecurityProtocolType]::Tls13; $wc = New-Object System.Net.WebClient; $wc.Encoding = [System.Text.Encoding]::UTF8; $text = ($wc.DownloadString('https://raw.githubusercontent.com/panel-mj/M-J/refs/heads/main/mj-scanner.txt') -split '---POWERSHELL---')[1].Trim(); [IO.File]::WriteAllText('mj-scanner.ps1', $text, [System.Text.Encoding]::UTF8); .\mj-scanner.ps1"
...
<p align="center"><a href="#"><b>#</b></a></p>

<p align="center">Thank you for using MJ Panel. This project is prepared for personal use.</p>

---

## Star History

<a href="https://www.star-history.com/?repos=panel-mj%2FM-J&type=date&legend=bottom-right">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=panel-mj/M-J&type=date&theme=dark&legend=bottom-right&sealed_token=r3Lb_3aKfu0utexFy3xJoisRGRSGS4OCoQg3ZS5TM1QCTppem2RU8sLiVsD6UQ38Ah92MwuZU_PjyQTFM5yY3rAw14WEjtonC70muFBH4RbXxBDGIy5iIw" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=panel-mj/M-J&type=date&legend=bottom-right&sealed_token=r3Lb_3aKfu0utexFy3xJoisRGRSGS4OCoQg3ZS5TM1QCTppem2RU8sLiVsD6UQ38Ah92MwuZU_PjyQTFM5yY3rAw14WEjtonC70muFBH4RbXxBDGIy5iIw" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=panel-mj/M-J&type=date&legend=bottom-right&sealed_token=r3Lb_3aKfu0utexFy3xJoisRGRSGS4OCoQg3ZS5TM1QCTppem2RU8sLiVsD6UQ38Ah92MwuZU_PjyQTFM5yY3rAw14WEjtonC70muFBH4RbXxBDGIy5iIw" />
 </picture>
</a>
...
This software is provided for **personal use**. By downloading or using this software, you agree to the following strict conditions:
